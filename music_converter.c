...
void main () {
    ...
    if (sharpFlat == '#' || sharpFlat == 'b') {
        printf("The key %c%c when converted from C Major to E Major is %c%c.", inputNote, sharpFlat, finalNote, finalSharpFlat);
    } else {
        printf("The key %c when converted from C Major to E Major is %c%c.", inputNote, finalNote, finalSharpFlat);
    }
